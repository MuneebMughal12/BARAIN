    ...
    <div>
      ...
      <div className="flex flex-col">
        {images.map((img, index) => (
          <motion.div
            key={index}
            className={`relative w-full h-[80vh] md:h-screen overflow-hidden cursor-pointer`}
            initial={{ opacity: 0 }}
          ...
          >
            ...
            />
            {/* Overlay */}
            <div className="absolute inset-0 bg-black bg-opacity-30 hover:bg-opacity-50 transition duration-300 flex items-center justify-center text-white text-xl md:text-4xl">
              VIEW IMAGE
            </div>
          </motion.div>
        ))}
